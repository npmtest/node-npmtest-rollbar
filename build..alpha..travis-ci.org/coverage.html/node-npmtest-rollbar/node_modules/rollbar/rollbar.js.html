...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-rollbar/node_modules/rollbar/rollbar.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-rollbar/node_modules/rollbar/rollbar.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-rollbar/node_modules/rollbar/</a> &#187; rollbar.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/*jslint devel: true, nomen: true, indent: 2, maxlen: 100 */
&nbsp;
"use strict";
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (!accessToken &amp;&amp; options.enabled !== false) {</span>
<span class="cstat-no" title="statement not covered" >      logger.error('Missing access_token.');</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    options.environment = options.environment || process.env.NODE_ENV || 'unspecified';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    api.init(accessToken, options);</span>
<span class="cstat-no" title="statement not covered" >    notifier.init(api, options);</span>
...
&nbsp;
&nbsp;
exports.errorHandler = <span class="fstat-no" title="function not covered" >function (accessToken, options) {</span>
  /*
   ...
   */
<span class="cstat-no" title="statement not covered" >  exports.init(accessToken, options);</span>
...
<span class="cstat-no" title="statement not covered" >    var cb = <span class="fstat-no" title="function not covered" >function (rollbarErr) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (rollbarErr) {</span>
<span class="cstat-no" title="statement not covered" >        logger.error('Error reporting to rollbar, ignoring: ' + rollbarErr);</span>
      }
<span class="cstat-no" title="statement not covered" >      return next(err, req, res);</span>
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return notifier.handleError(err, req, cb);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return notifier.reportMessage('Error: ' + err, 'error', req, cb);</span>
  };
};
&nbsp;
exports.handleUncaughtExceptionsAndRejections = <span class="fstat-no" title="function not covered" >function (accessToken, options) {</span>
<span class="cstat-no" title="statement not covered" >  exports.handleUncaughtExceptions(accessToken, options);</span>
<span class="cstat-no" title="statement not covered" >  exports.handleUnhandledRejections(accessToken, options);</span>
};
&nbsp;
exports.handleUncaughtExceptions = <span class="fstat-no" title="function not covered" >function (accessToken, options) {</span>
  /*
...
<span class="cstat-no" title="statement not covered" >  options = options || {};</span>
<span class="cstat-no" title="statement not covered" >  var exitOnUncaught = options.exitOnUncaughtException === undefined ?</span>
        false : !!options.exitOnUncaughtException;
<span class="cstat-no" title="statement not covered" >  delete options.exitOnUncaughtException;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.init(accessToken, options);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (initialized) {</span>
...
<span class="cstat-no" title="statement not covered" >      logger.error('Handling uncaught exception.');</span>
<span class="cstat-no" title="statement not covered" >      logger.error(err);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      notifier.handleError(err, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          logger.error('Encountered an error while handling an uncaught exception.');</span>
<span class="cstat-no" title="statement not covered" >          logger.error(err);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (exitOnUncaught) {</span>
<span class="cstat-no" title="statement not covered" >          process.exit(1);</span>
        }
      });
    });
  } else {
<span class="cstat-no" title="statement not covered" >    logger.error('Rollbar is not initialized. Uncaught exceptions will not be tracked.');</span>
  }
};
&nbsp;
exports.handleUnhandledRejections = <span class="fstat-no" title="function not covered" >function (accessToken, options) {</span>
  /*
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (initialized) {</span>
<span class="cstat-no" title="statement not covered" >    process.on('unhandledRejection', <span class="fstat-no" title="function not covered" >function (reason) {</span></span>
<span class="cstat-no" title="statement not covered" >      logger.error('Handling unhandled rejection.');</span>
<span class="cstat-no" title="statement not covered" >      logger.error(reason);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      notifier.handleError(reason, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          logger.error('Encountered an error while handling an unhandled rejection.');</span>
<span class="cstat-no" title="statement not covered" >          logger.error(err);</span>
        }
      })
    });
  } else {
<span class="cstat-no" title="statement not covered" >    logger.error('Rollbar is not initialized. Uncaught rejections will not be tracked.');</span>
  }
};
&nbsp;
